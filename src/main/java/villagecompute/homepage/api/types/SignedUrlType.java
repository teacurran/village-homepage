 ...
 *
 * <p>
 * Generated by StorageGateway to provide time-limited access to S3/R2 objects without exposing
 * bucket credentials.
 *
 * <p>
...
public record SignedUrlType(@NotBlank String url, @NotBlank @JsonProperty("expires_at") String expiresAt,
        @NotNull @JsonProperty("ttl_minutes") Integer ttlMinutes, @NotBlank @JsonProperty("object_key") String objectKey) {
}
