 ...
 *
 * <p>
 * Returned by StorageGateway after uploading a file to S3/R2. Contains object key, size, and metadata for tracking
 * uploads.
 *
 * <p>
 ...
 */
public record StorageUploadResultType(@NotBlank @JsonProperty("object_key") String objectKey, @NotBlank String bucket,
        @NotNull @JsonProperty("size_bytes") Long sizeBytes, @NotBlank @JsonProperty("content_type") String contentType,
        @NotBlank String variant, String version, @NotBlank @JsonProperty("uploaded_at") String uploadedAt) {
}
