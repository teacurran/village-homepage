 ...
 *
 * <p>
 * Handlers must be CDI-managed beans annotated with {@code @ApplicationScoped} and implement this interface. The
 * {@link DelayedJobService} discovers handlers at runtime and routes jobs based on their {@link JobType}.
 *
 * <p>
 * <b>Execution Model:</b>
 * <ul>
...
public interface JobHandler {
     ...
     *
     * <p>
     * The {@link DelayedJobService} uses this method to build a registry of type → handler mappings at application
     * startup.
     *
     ...
     *
     * <p>
     * <b>Thread Safety:</b> This method may be called concurrently by multiple worker threads. Implementations must be
     * thread-safe or use external synchronization.
     *
     * <p>
     * <b>Error Handling:</b> Thrown exceptions trigger retry logic per the job's {@code max_attempts} and exponential
     * backoff strategy. After exhausting retries, jobs move to a failed state and trigger alerting per escalation
     * policy.
     *
     * <p>
     * <b>Telemetry:</b> The following OpenTelemetry attributes are automatically recorded:
     * <ul>
     ...
     *
     * @param jobId
     *            the database primary key from {@code delayed_jobs.id}
     * @param payload
     *            deserialized job parameters (stored as JSONB in database)
     * @throws Exception
     *             any error during execution; triggers retry logic
     */
